...
final class MachineTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Machine>
     */
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ->addColumn('id')
            ->addColumn('name')
            ->addColumn('company_id', fn ($model) => strtolower(e($model->company->name)))
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('Description'), 'description')
                ->sortable()
                ->searchable(),
            Column::make(__('Company'), 'company_id'),
    ...
    public function filters(): array
    {
        return [
            ...
            Filter::select('company_id')->dataSource(Company::all())->optionLabel('name')->optionValue('id'),
        ];
    }
    ...
    */
    ...
    /**
     * PowerGrid Machine Action Buttons.
     *
    ...
    public function actions(): array
    {
        return [
            Button::add('edit')
                ...
                ->openModal('machine-modal', ['machine' => 'id']),
            ...
            //     ->emit('confirmDeleteMachine', ['id' => 'id'])
        ];
    }

    public function onUpdatedToggleable(string $id, string $field, string $value): void
    {
        Machine::withoutGlobalScopes()->find($id)->update([
            $field => $value,
        ]);
    }
    ...
    /**
     * PowerGrid Machine Action Rules.
     *
    ...
    /**
     * Function to save the Machine
     * @param array $data
     * Array with Machine data
     * @param $id
     * If $id param is provided, we must update instead create Machine
     */
    public function saveMachine($data, $id = null)
    {
        $id ? $this->showAlerts('MODIFIED', Machine::find($id)->update($data)) : $this->showAlerts('CREATED', Machine::create($data));
    }
    ...
    public function showAlerts($action, $status)
    {
        ...
        $this->emit('notificationAlert', ['type' => $type_alert, 'title' => config('constants.' . $this->messages_lang . '.MACHINE.' . $action . '.TITLE'), 'text' => config('constants.' . $this->messages_lang . '.MACHINE.' . $action . '.TEXT')]);
    }
}
