<aside x-data="sidebar" id="default-sidebar"
    ...
    <div
        ...
        <a href="{{ route('index') }}" class="flex items-center pl-2.5 mb-5">
            ...
            <span
                class="self-center text-xl font-semibold whitespace-nowrap text-[#D02321]">Gestión documentos</span>
        </a>
        <ul class="space-y-2">
            <li>
                    ...
                    <ul id="dropdown-promoters" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('promoters') }}"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Promoters') }}</a>
                        </li>
            ...
            @can('See workers')
                <li>
                    <button type="button"
                     ...
                     font-normal text-gray-900 transition duration-75
                      rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 aria-[expanded=true]:[&>*]:text-red-500"
                        aria-controls="dropdown-worker" data-collapse-toggle="dropdown-worker">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872
                                 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5
                                  0a2.18 2.18 0 00.75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 00-3.413-.387m4.5
                                  8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0112 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016
                                  2.016 0 01-.673-.38m0 0A2.18 2.18 0 013 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111
                                   0 013.413-.387m7.5 0V5.25A2.25 2.25 0 0013.5 3h-3a2.25 2.25 0 00-2.25 2.25v.894m7.5 0a48.667 48.667 0 00-7.5 0M12 12.75h.008v.008H12v-.008z" />
                        </svg>
                    ...
                    <ul id="dropdown-worker" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('workers') }}"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('See workers') }}</a>
                        </li>
                    </ul>
                </li>
            @endcan
                        ...
                        @role('Administrator')
                            ...
                            <li>
                                <a href="{{ route('especialty') }}"
                                    class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Especialties') }}</a>
                            </li>
                        @endrole
                    </ul>
                </li>
            ...
            @can('See machines')
                ...
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        aria-controls="dropdown-machines" data-collapse-toggle="dropdown-machines">

                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-700 transition duration-75 dark:text-gray-400 group-hover:text-gray-400 dark:group-hover:text-white">
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap">{{ __('Machines') }}</span>
                        <svg aria-hidden="true" class="w-6 h-6 rotate-[-90deg]" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                    ...
                    <ul id="dropdown-machines" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('machines') }}"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('See machines') }}</a>
                        </li>
                    </ul>
                </li>
            @endcan
        ...
        <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
            @can('Create documentation templates')
                {{-- DOCUMENTS --}}
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    ...
                    <ul id="dropdown-documents" class="hidden py-2 space-y-2">
                        {{-- Documents --}}
                        @can('Validate documentation')
                            <li>
                                <a href="{{ route('documents') }}"
                                    class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Documents') }}</a>
                            </li>
                        @endcan
                        {{-- Template --}}
                        <li>
                            <a href="{{ route('documents-templates') }}"
                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Templates') }}</a>
                        </li>
                        @can('Create documents types')
                            <li>
                                <a href="{{ route('documents-types') }}"
                                    class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Document types') }}</a>
                            </li>

                            <li>
                                <a href="{{ route('expirations') }}"
                                    class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Document expirations') }}</a>
                            </li>
                        @endcan
