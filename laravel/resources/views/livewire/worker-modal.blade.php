        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    {{ $insert ? __('Create') : __('Edit') }} {{ __('worker') }}
                </h3>
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                    ...
                    {{-- nif --}}
                    <x-input wire:model="state.nif" label="{{ __('CIF') }}" id="nif" name="nif"
                        placeholder="{{ __('Enter nif') }}" required autocomplete="nif" />
                    ...
                    <x-input pattern="[0-9]" wire:model="state.phone_1" label="{{ __('Phone') }}" id="phone_1"
                        name="phone_1" placeholder="{{ __('Enter phone') }}" autocomplete="phone_1"
                    ...
                    <x-input wire:model="state.province" label="{{ __('Province') }}" id="province" name="province"
                        placeholder="{{ __('Enter province') }}" autocomplete="province" />

                    {{-- City --}}
                    <x-input wire:model="state.city" label="{{ __('City') }}" id="city" name="city"
                        placeholder="{{ __('Enter city') }}" autocomplete="city" />

                    {{-- Postal code --}}
                    <x-input wire:model="state.postal_code" label="{{ __('Postal code') }}" id="postal_code"
                        name="postal_code" placeholder="{{ __('Enter postal code') }}" autocomplete="postal_code"
                    ...
                    <div class="col-span-2">
                        ...
                        <x-input wire:model="state.address" label="{{ __('Address') }}" id="address" name="address"
                            placeholder="{{ __('Enter address') }}" autocomplete="address" />
                    </div>
                </div>
            </div>
            <!-- Modal footer -->
